...
Интерфейс для управления ключами (генерация и запись ключей в пару файлов, чтение из файла закрытого ключа при создании подписи и открытого ключа при проверке подписи) не предусмотрен. Для реального использования данный интерфейс необходим.
...
$ tests/signature make file file.sg
$ tests/signature test file file.sg
